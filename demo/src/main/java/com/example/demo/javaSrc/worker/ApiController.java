...
import org.springframework.security.core.Authentication;        // ← для отримання поточного користувача
import org.springframework.security.crypto.password.PasswordEncoder; // ← для хешування пароля
